...
define('TZN_USER_ID_LENGTH',20);		// length of room/user ID
...
define('TZN_USER_PASS_MAX',20);		// maximum length for password
...
// TaskFreak! skin
define('FRK_DEFAULT_SKIN_FOLDER','bluefreak'); // or bluefreak
